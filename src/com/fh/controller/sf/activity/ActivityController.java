package com.fh.controller.sf.activity;
...
public class ActivityController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("ATT"));	    //2
			vpd.put("var3", varOList.get(i).getString("BEGTIME"));	    //3
			vpd.put("var4", varOList.get(i).getString("ENDTIME"));	    //4
			vpd.put("var5", varOList.get(i).getString("UNIT"));	    //5
			vpd.put("var6", varOList.get(i).getString("RULES"));	    //6
			vpd.put("var7", varOList.get(i).getString("OBJECT"));	    //7
			vpd.put("var8", varOList.get(i).getString("PRIZE"));	    //8
			vpd.put("var9", varOList.get(i).getString("AWARDTIME"));	    //9
			vpd.put("var10", varOList.get(i).getString("AWARDADDRESS"));	    //10
			vpd.put("var11", varOList.get(i).getString("CREATEMAN"));	    //11
