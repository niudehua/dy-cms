package com.fh.controller.xshc.template;
...
public class TemplateController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("xshc/template/template_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("xshc/template/template_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("TEMPLATE"));	    //2
			vpd.put("var3", varOList.get(i).getString("CREATETIME"));	    //3
			vpd.put("var4", varOList.get(i).getString("CREATEMAN"));	    //4
