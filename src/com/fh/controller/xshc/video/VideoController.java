package com.fh.controller.xshc.video;
...
public class VideoController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("xshc/video/video_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("xshc/video/video_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("VIDEO"));	    //2
			vpd.put("var3", varOList.get(i).getString("APPUSERID"));	    //3
